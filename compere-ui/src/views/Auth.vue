  ...
  <div class="min-h-[60vh] flex items-center justify-center">
    <div class="card p-8 max-w-md w-full">
      <div class="text-center mb-8">
        ...
        <h1 class="text-xl font-bold text-surface-900 mb-2">Welcome to Compere</h1>
        <p class="text-surface-500">Sign in to access your rating system</p>
      </div>
      ...
      <form @submit.prevent="login" class="space-y-6">
        ...
        <div v-if="authStore.error" class="p-4 rounded-lg bg-red-100 border border-red-300 text-red-700">
      ...
      <div class="mt-8 p-4 rounded-lg bg-surface-100">
        <h3 class="font-semibold text-surface-900 mb-3">Demo Credentials:</h3>
